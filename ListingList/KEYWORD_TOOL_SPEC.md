...
**Gap detection logic:**
- Search the platform for each keyword phrase
- Count number of results returned
- Low results + autocomplete presence = GAP opportunity
- Display as traffic light: 🟢 Gap (low competition) / 🟡 Medium / 🔴 Saturated
