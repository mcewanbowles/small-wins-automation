...
def create_page_canvas(width=PAGE_WIDTH, height=PAGE_HEIGHT, background_color=COLORS['background'], mode='color'):
    """
...
def add_footer(image, footer_text=None, page_num=None, font_manager=None, mode='color'):
    """
    ...
    Args:
        ...
        page_num: Optional page number to display
