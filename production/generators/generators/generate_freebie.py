...
def generate_freebie_cover(c, width, height, product_title):
    ...
    c.setFont('Helvetica', 9)
    c.drawCentredString(width/2, footer_y, "⭐ Small Wins Studio  © 2026 All rights reserved.")
...
def generate_sample_activity_page(c, width, height, level, product_type='Matching'):
    ...
    c.drawCentredString(width/2, footer_y - 8, "⭐ Small Wins Studio  © 2026")
...
def generate_cutouts_page(c, width, height, level, product_type='Matching'):
    ...
    c.setFillColor(LIGHT_GRAY)
    c.setFont('Helvetica', 8)
    c.drawCentredString(width/2, footer_y, "⭐ Small Wins Studio  © 2026 - FREE SAMPLE")
...
def generate_storage_labels_page(c, width, height):
    ...
    c.setFillColor(LIGHT_GRAY)
    c.setFont('Helvetica', 8)
    c.drawCentredString(width/2, footer_y, "⭐ Small Wins Studio  © 2026 - FREE SAMPLE - Print on cardstock for durability")
