...
Creates 4 difficulty levels + answer key (5 pages total)
Same words and images across all levels

Level 1: Symbol padding (●■▲★), horizontal/vertical only - EASIEST
Level 2: Letter padding, horizontal/vertical only
Level 3: Letter padding, includes diagonal
Level 4: Smaller cells, tighter grid - HARDEST
+ Answer Key page
"""
...
def create_word_search_page(words, theme_images, theme_names, level, page_num,
    ...
    level_labels = {1: 'Beginner', 2: 'Easy', 3: 'Medium', 4: 'Independent Reader'}
    ...
    # Level indicator
    level_descriptions = {
        1: "Level 1 - Beginner (Symbol Background)",
        2: "Level 2 - Easy (Letters, No Diagonals)",
        3: "Level 3 - Medium (Letters + Diagonals)",
        4: "Level 4 - Independent Reader (Text-only, diagonals)"
    }
...
def generate_word_search(images_folder, pack_code="WAN1-A", theme_name="Winter Animals"):
    ...
    levels_config = [
        {"level": 1, "grid_size": 8, "use_symbols": True, "allow_diagonal": False, "cell_size": None},
...
✨ WHAT'S INCLUDED:
• 4 Word Search pages (4 different difficulty levels)
• 1 Answer Key page
